...
var TextEngine = function () {
  ...
  TextEngine.prototype.layout = function layout(width, dirty) {
    ...
    var path = new Path().rect(0, 0, width, INFINITY);
    var container = new Container(path);
    var string = AttributedString.fromFragments(this.attributedString).trim();
...
export { Document$$1 as Document, pdf, View, Text, Link, Page, Font, Image, StyleSheet, PDFRenderer, createElement };
export default dom;
